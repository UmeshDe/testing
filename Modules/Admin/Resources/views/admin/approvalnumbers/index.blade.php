        ...
        <div class="col-xs-12">
            <div class="row">
                <div class="btn-group pull-right" style="margin: 0 15px 15px 0;">
                    <a href="{{ route('admin.admin.approvalnumber.create') }}" class="btn btn-primary btn-flat" style="padding: 4px 10px;">
                        <i class="fa fa-pencil"></i> {{ trans('admin::approvalnumbers.button.create approvalnumber') }}
                    </a>
                </div>
            </div>
                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table class="data-table table table-bordered table-hover">
                            ...
                            <tbody>
                            <?php if (isset($approvalnumbers)): ?>
                            <?php foreach ($approvalnumbers as $approvalnumber): ?>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('admin.admin.approvalnumber.edit', [$approvalnumber->id]) }}" class="btn btn-default btn-flat"><i class="fa fa-pencil"></i></a>

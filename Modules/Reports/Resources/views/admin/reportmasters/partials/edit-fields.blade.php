<div class="box-body">
    ...
    <div class="box-body">
            ...
            <div class="col-md-3">
                ...
                <div class=" form-group has-feedback {{ $errors->has('report_date') ? ' has-error has-feedback' : '' }}">
                    ...
                    <select class="select form-control" id="report_date" name="report_date">
                        @if($reportmaster->id == 3 || $reportmaster->id == 18 || $reportmaster->id == 20 || $reportmaster->id == 21 || $reportmaster->id == 27 || $reportmaster->id == 23 || $reportmaster->id == 19 || $reportmaster->id == 29)
                            <option value="0">Production Date</option>
                            <option></option>
                        @endif
                        @if($reportmaster->id == 3 || $reportmaster->id == 29 || $reportmaster->id == 18 || $reportmaster->id == 20 || $reportmaster->id == 22 || $reportmaster->id == 21 || $reportmaster->id == 23 || $reportmaster->id == 19)
        ...
        {{--<div class="row">--}}
            ...
            {{--</div>--}}
            {{--@endif--}}
        @if($reportmaster->id == 11 || $reportmaster->id == 17)
            <div class="col-md-4">
                <div class="form-group">
                <label for="report_Type">
                    Vehicle No.
        ...
        @endif
        @if($reportmaster->id == 11 || $reportmaster->id == 17 || $reportmaster->id == 24)
            <div class="col-md-4">
                <div class="form-group">
                    <label for="report_Type">
                        Container No.
        ...
        {{--</div>--}}
        {{--<div class="row">--}}
        {{--@if($reportmaster->id == 22 || $reportmaster->id == 29 )--}}

        {{--@endif--}}
        {{--@if($reportmaster->id == 22 || $reportmaster->id == 29 || $reportmaster->id == 3)--}}
            {{--<div class="col-md-3">--}}
                {{--<div class="form-group">--}}
                    {{--<label for="report_Type" class="control-label col-lg-4 col-sm-4">--}}
                        {{--Variety--}}
        ...
        @if($reportmaster->id == 29)
                ...
                {{--</div>--}}
        @endif
        {{--@if($reportmaster->id == 29 || $reportmaster->id == 3)--}}
                {{--<div class="col-md-3">--}}
                    {{--<div class="form-group">--}}
                        {{--<label for="report_Type">--}}
                            {{--PO--}}
        ...
        @if($reportmaster->id == 28 || $reportmaster->id == 29)
        <div class="col-md-4">
            {!!
            Former::select('place')
            ->fromQuery($place,'location','id')
        ...
        @endif
        @if($reportmaster->id == 22 || $reportmaster->id == 28 || $reportmaster->id == 29 || $reportmaster->id == 3 || $reportmaster->id == 18)
            <div class="col-md-4">
                {{--<div class="form-group">--}}
                {{--<label for="report_Type" class="control-label col-lg-4 col-sm-4">--}}
                {{--Variety--}}
        ...
        @endif
        @if($reportmaster->id == 28 || $reportmaster->id == 29 || $reportmaster->id == 3 || $reportmaster->id == 18)
            <div class="col-md-4">
                {!!
        ...
        @endif
        @if($reportmaster->id == 27 || $reportmaster->id == 3  || $reportmaster->id == 25)
            <div class="col-md-4">
                <div class="form-group">
                    <label for="report_Type">
                        PO
        ...
        @if($reportmaster->id == 29 || $reportmaster->id == 22)
        <div class="col-md-4">
            {{--<div class="form-group">--}}
                {{--<label for="report_Type" class="control-label col-lg-4 col-sm-4">--}}
                    {{--Grade--}}

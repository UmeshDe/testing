        ...
        <div class="col-xs-12">
            <div class="row">
                <div class="btn-group pull-right" style="margin: 0 15px 15px 0;">
                    <a href="{{ route('admin.reports.reportmodule.create') }}" class="btn btn-primary btn-flat" style="padding: 4px 10px;">
                        <i class="fa fa-pencil"></i> {{ trans('reports::reportmodule.button.create reportlog') }}
                    </a>
                </div>
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="data-table table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('admin.reports.reportmodule.edit', [$reportmodule->id]) }}" class="btn btn-default btn-flat"><i class="fa fa-pencil"></i></a>

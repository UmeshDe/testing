...
@section('content')
    <table style="margin-top: 5%">
        ...
        <tr>
            <td colspan="15" align="left"> {{$report->reportMaster->sub_title = 'Transfer From Date: ' . \Carbon\Carbon::parse($report->startDate)->format(PHP_DATE_FORMAT) . '____Transfer To Date:' .\Carbon\Carbon::parse($report->endDate)->format(PHP_DATE_FORMAT) }}</td>
        </tr>
        <tr>
            <td colspan="10">Loading Date</td>
            <td colspan="5">Unloading Date</td>
        </tr>
        <tr>
